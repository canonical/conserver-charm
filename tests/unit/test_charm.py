...
def test_invalid_base64_config_file(conserver_mock: MagicMock, ctx: testing.Context):
...
@patch("charm.Conserver")
def test_invalid_base64_passwd_file(
    conserver_mock: MagicMock, ctx: testing.Context, config_file: str
):
...
@patch("charm.Conserver")
def test_install(conserver_mock: MagicMock, ctx: testing.Context, config_file: str):
...
@patch("charm.Conserver")
def test_config_missing_config_file(conserver_mock: MagicMock, ctx: testing.Context):
...
@patch("charm.Conserver")
def test_config_missing_passwd_file(
    conserver_mock: MagicMock, ctx: testing.Context, config_file: str
):
...
@patch("charm.Conserver")
def test_start(conserver_mock: MagicMock, ctx: testing.Context, config_file: str):
...
@patch("charm.Conserver")
def test_start_failed_service(conserver_mock: MagicMock, ctx: testing.Context, config_file: str):
...
@patch("charm.Conserver")
def test_start_maintenance(conserver_mock: MagicMock, ctx: testing.Context, config_file: str):
...
@patch("charm.Conserver")
def test_stop(conserver_mock: MagicMock, ctx: testing.Context):
